...
def predict():
    ...
    model_name_or_path = basedir + '/results/bestvit'
    ...
    np.save(basedir + '/vitprobs', prob)
    np.save(basedir + '/vitindices', indices)
    ...
    submission.drop([0])
    submission.to_csv(basedir+'/vitsubmit.csv', index=False)
